...
for idata = 1:ndata
    if xdata(idata,4) == 1
        ydata(idata)=(benzenePropsfitV(a1,xdata(idata,1:2))-xdata(idata,3))^2;
    elseif xdata(idata,4) == 4
        ydata(idata)=(benzenePropsfitalpha(a1,xdata(idata,1:2))-xdata(idata,3))^2;
    elseif xdata(idata,4) == 5
        ydata(idata)=(benzenePropsfitcp(a1,xdata(idata,1:2))-xdata(idata,3))^2;
    elseif xdata(idata,4) == 6
        ydata(idata)=(benzenePropsfitcv(a1,xdata(idata,1:2))-xdata(idata,3))^2;
    elseif xdata(idata,4) == 11
        ydata(idata)=(benzenePropsfitH(a1,xdata(idata,1:2))-xdata(idata,3))^2;
    else
